...
<html class="no-js" lang="en">
    <head>
        ...
        <link rel="stylesheet" href="bootstrap/plugins/bootstrap/dist/css/bootstrap.min.css">
        <link rel="stylesheet" href="bootstrap/plugins/fontawesome-free/css/all.min.css">
        <link rel="stylesheet" href="bootstrap/plugins/ionicons/dist/css/ionicons.min.css">
        <link rel="stylesheet" href="bootstrap/plugins/icon-kit/dist/css/iconkit.min.css">
        <link rel="stylesheet" href="bootstrap/plugins/fullcalendar/dist/fullcalendar.min.css">
        <link rel="stylesheet" href="bootstrap/plugins/perfect-scrollbar/css/perfect-scrollbar.css">
        <link rel="stylesheet" href="bootstrap/plugins/tempusdominus-bootstrap-4/build/css/tempusdominus-bootstrap-4.min.css">
        <link rel="stylesheet" href="bootstrap/dist/css/theme.min.css">
        <script src="bootstrap/src/js/vendor/modernizr-2.8.3.min.js"></script>
    </head>
    ...
    <body>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right notification-dropdown" aria-labelledby="notiDropdown">
                                    ...
                                    <div class="notifications-wrap">
                                        ...
                                        <a href="#" class="media">
                                            <span class="d-flex">
                                                <img src="bootstrap/img/users/1.jpg" class="rounded-circle" alt="">
                                            </span>
                                            <span class="media-body">
                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                <div class="nav-lavel">Principal</div>
                                <div class="nav-item">
                                    <a href="Index.jsp"><i class="ik ik-bar-chart-2"></i><span>Home</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="Agenda.jsp"><i class="ik ik-menu"></i><span>Agenda</span> </a>
                                </div>
                                <div class="nav-item has-sub">
                                    <a href="Contatos.jsp"><i class="ik ik-layers"></i><span>Contatos</span></a>
                                ...
                                <div class="nav-item active">
                                    <a href="Calendario.jsp"><i class="ik ik-calendar"></i><span>Calend&aacute;rio</span></a>
                                </div>
                                <div class="nav-item">
                                    <a href="TaskList.jsp"><i class="ik ik-server"></i><span>Lista de Tarefas</span></a>
                                </div>
                    ...
                    <div class="container-fluid">
                                ...
                                <div class="col-lg-4">
                                    <nav class="breadcrumb-container" aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item active" aria-current="page">Calend&aacute;rio</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                                ...
                                <form class="editEventForm">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn btn-danger delete-event" type="submit">Deletar</button>
                                            <button class="btn btn-success save-event" type="submit">Salvar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="modal" id="addEvent" tabindex="-1" role="dialog" aria-labelledby="addEventLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="addEventLabel">Adicionar novo evento</h5>
                                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    </div>
                                    <div class="modal-body">
                                        <form id="addEventForm">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="eventName" name="eventName" placeholder="Por favor insira o nome do evento">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group mb-0" id="addColor">
                                                <label for="colors">Escolher cor</label>
                                    ...
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Fechar</button>
                                        <button type="button" class="btn btn-success save-event">Salvar</button>
                        ...
                        <div class="chat-list">
                            <div class="list-group row">
                                ...
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Billy Black">
                                    <figure class="user--online">
                                        <img src="bootstrap/img/users/2.jpg" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Billy Black</span>  <span class="username">@billyblack</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Herbert Diaz">
                                    <figure class="user--online">
                                        <img src="bootstrap/img/users/3.jpg" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Herbert Diaz</span>  <span class="username">@herbert</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item" data-chat-user="Sylvia Harvey">
                                    <figure class="user--busy">
                                        <img src="bootstrap/img/users/4.jpg" class="rounded-circle" alt="">
                                    </figure><span><span class="name">Sylvia Harvey</span>  <span class="username">@sylvia</span> </span>
                                </a>
                                <a href="javascript:void(0)" class="list-group-item active" data-chat-user="Marsha Hoffman">
                                    <figure class="user--busy">
                                        <img src="bootstrap/img/users/5.jpg" class="rounded-circle" alt="">
        ...
        <script>window.jQuery || document.write('<script src="bootstrap/src/js/vendor/jquery-3.3.1.min.js"><\/script>')</script>
        <script src="bootstrap/plugins/popper.js/dist/umd/popper.min.js"></script>
        <script src="bootstrap/plugins/bootstrap/dist/js/bootstrap.min.js"></script>
        <script src="bootstrap/plugins/perfect-scrollbar/dist/perfect-scrollbar.min.js"></script>
        <script src="bootstrap/plugins/screenfull/dist/screenfull.js"></script>
        <script src="bootstrap/plugins/moment/moment.js"></script>
        <script src="bootstrap/plugins/fullcalendar/dist/fullcalendar.min.js"></script>
        <script src="bootstrap/plugins/tempusdominus-bootstrap-4/build/js/tempusdominus-bootstrap-4.min.js"></script>
        <script src="bootstrap/dist/js/theme.min.js"></script>
